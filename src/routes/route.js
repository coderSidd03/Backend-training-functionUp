...
//  step2:[BEST PRACTICE]:- always write s2 upload function separately- in a separate file/function..expect it to take file as input and return the uploaded file as output
// step3: aws-sdk install - as package
// step4: Setupconfig for aws authentication- use code below as plugin keys that are given to you
//  step5: build the uploadFile function for uploading file- use code below and edit what is marked HERE only
